...
$botToken =  "5040052817:AAGIT8y3YhAo4RmacFBls-jLDBv4YHmPbMQ";
...
$free = json_encode($keyboard);
        file_get_contents("https://api.telegram.org/bot15040052817:AAGIT8y3YhAo4RmacFBls-jLDBv4YHmPbMQ8/editMessageText?chat_id=$cchatid2&text=$freecommands&message_id=$cmessage_id2&parse_mode=HTML&reply_markup=$free");
...
$free = json_encode($keyboard);
        file_get_contents("https://api.telegram.org/bot5040052817:AAGIT8y3YhAo4RmacFBls-jLDBv4YHmPbMQ/editMessageText?chat_id=$cchatid2&text=$freecommands&message_id=$cmessage_id2&parse_mode=HTML&reply_markup=$free");
...
file_get_contents("https://api.telegram.org/bot5040052817:AAGIT8y3YhAo4RmacFBls-jLDBv4YHmPbMQ/editMessageText?chat_id=$cchatid2&text=$finalize&message_id=$cmessage_id2&parse_mode=HTML");
}
...
$premium_id = (array("5054432298","1410693644"));
$premiumgp = (array("-"-656801545"));
        $keyboard = json_encode([
'inline_keyboard' => [
[['text' => "OWNER", 'url' => "https://t.me/sexmaster"],]
]]);
                $keyboard1 = json_encode([
'inline_keyboard' => [
[['text' => "CHANNEL", 'url' => "https://t.me/discordbin"],
['text' => "GROUP", 'url' => "https://t.me/bundxchat"],]
]]);

// if(!in_array($chatId, $premiumgp)){
	// $tch = json_decode(file_get_contents("https://api.telegram.org/bot5040052817:AAGIT8y3YhAo4RmacFBls-jLDBv4YHmPbMQ/getChatMember?chat_id=@roldexverse&user_id=".$gId))->result->status;
...
if(strpos($message, '!key') === 0 or strpos($message, '/key') === 0 or strpos($message, '.key') === 0){
    $keyboard = [
    'inline_keyboard' => [[['text' => 'Features', 'callback_data' => 'paid'], ['text' => 'Buy', 'callback_data' => 'buy'], ['text' => 'Buy Now', 'url' => 'https://t.me/sexmaster'],]]];
...
function bot($method,$datas=[]){
    $url = "https://api.telegram.org/bot5040052817:AAGIT8y3YhAo4RmacFBls-jLDBv4YHmPbMQ/".$method;
    $ch = curl_init();
...
global $botToken;
$url = "https://api.telegram.org/bot".$botToken."/editMessageText?chat_id=".$chatId."&message_id=".$message_id."&text=••MASS CHECKER%0A".$message."%0A••• BOT BY: @sexmaster&parse_mode=HTML";
